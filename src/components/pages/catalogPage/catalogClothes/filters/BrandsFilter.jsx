...
const BrandsFilter = ({ onSelectedBrands, clothes }) => {
    ...
    clothes.forEach(clothes => {
        uniqueBrands.add(clothes.brand)
    });
    ...
    return (
        <div className='flex flex-col items-center justufy-start rounded-lg border border-gray-300 p-6 gap-5 w-full' style={{marginBottom: '30px'}}>
            ...
            <div className='flex  flex-col item-center justify-start overflow-x-auto scrollbar-thumb-black scrollbar-track-gray-300 w-full' style={{maxHeight: '275px'}}>
                {
